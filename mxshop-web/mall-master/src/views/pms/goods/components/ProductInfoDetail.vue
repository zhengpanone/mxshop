    ...
    >
      ...
      <el-form-item style="text-align: center">
        <el-button
          ...
          v-if="!disabled"
          size="medium"
          @click="finishCommit('productInfoForm')"
          >确认</el-button
        >
        <el-button type="primary" v-else size="medium" @click="edit()"
          >编辑</el-button
        >
      </el-form-item>
    </el-form>
...
const getGoods = async () => {
  try {
    ...
    value.value.desc_images = response.desc_images.map((item: any) => ({
      url: item,
    }));
...
const finishCommit = async () => {
  ...
  value.value.category =
    value.value.third_cate || value.value.second_cate || value.value.first_cate;
