...
from order_srv.proto import order_pb2 as order__pb2
...
class Order(object):
    ...
    def CarItemList(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Order/CarItemList',
    ...
    def CreateCartItem(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Order/CreateCartItem',
    ...
    def UpdateCartItem(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Order/UpdateCartItem',
            order__pb2.CartItemRequest.SerializeToString,
    ...
    def DeleteCartItem(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Order/DeleteCartItem',
            order__pb2.CartItemRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def OrderList(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Order/OrderList',
    ...
    def OrderDetail(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Order/OrderDetail',
            order__pb2.OrderRequest.SerializeToString,
