...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ROLEFILTERPAGEINFO']._serialized_end=379
  _globals['_ROLELISTRESPONSE']._serialized_start=381
  _globals['_ROLELISTRESPONSE']._serialized_end=447
